...
_PROPSATPROBLEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="formula",
            full_name="PropSatProblem.formula",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="timeout",
            full_name="PropSatProblem.timeout",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_PROPSATSOLUTION_ASSIGNMENTENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="PropSatSolution.AssignmentEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="PropSatSolution.AssignmentEntry.value",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_PROPSATSOLUTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="status",
            full_name="PropSatSolution.status",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="assignment",
            full_name="PropSatSolution.assignment",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _PROPSATSOLUTION_ASSIGNMENTENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_CNFFORMULA = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="num_clauses",
            full_name="CNFFormula.num_clauses",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="symbol_table",
            full_name="CNFFormula.symbol_table",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
_CNFSATPROBLEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="formula",
            full_name="CNFSatProblem.formula",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="timeout",
            full_name="CNFSatProblem.timeout",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_CNFSATSOLUTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="status",
            full_name="CNFSatSolution.status",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="assignment",
            full_name="CNFSatSolution.assignment",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="clausal_proof",
            full_name="CNFSatSolution.clausal_proof",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="res_proof",
            full_name="CNFSatSolution.res_proof",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
PropSatProblem = _reflection.GeneratedProtocolMessageType(
    "PropSatProblem",
    (_message.Message,),
    {
...
PropSatSolution = _reflection.GeneratedProtocolMessageType(
    "PropSatSolution",
    (_message.Message,),
    {
        "AssignmentEntry": _reflection.GeneratedProtocolMessageType(
            "AssignmentEntry",
            (_message.Message,),
            {
...
ResClause = _reflection.GeneratedProtocolMessageType(
    "ResClause",
    (_message.Message,),
    {
...
CNFFormula = _reflection.GeneratedProtocolMessageType(
    "CNFFormula",
    (_message.Message,),
    {
...
CNFSatProblem = _reflection.GeneratedProtocolMessageType(
    "CNFSatProblem",
    (_message.Message,),
    {
...
CNFSatSolution = _reflection.GeneratedProtocolMessageType(
    "CNFSatSolution",
    (_message.Message,),
    {
